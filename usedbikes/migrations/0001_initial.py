# Generated by Django 4.0.4 on 2022-06-12 07:57
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('seller', 'seller'), ('buyer', 'buyer')], default='buyer', max_length=120)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('profile_photo', models.ImageField(null=True, upload_to='bikeprofile')),
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='usedbikes', to=settings.AUTH_USER_MODEL)),
            ],
        ),
    ]
